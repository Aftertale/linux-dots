...
keys = [
    ...
    Key([mod, shift], "l", lazy.spawn("i3lock-fancy"), desc="Lock Screen"),
    ...
    # keychords
    KeyChord([mod], "l", [
        Key([], "a", lazy.spawn("azure"), desc="google-chrome --profile-directory=Profile\ 2 --app=https://portal.azure.com/#home --class=azure"),
        Key([], "d", lazy.spawn("dynatrace"), desc="google-chrome --profile-directory=Profile\ 2 --app=https://dynatrace.np.costco.com --class=dynatrace"),
        Key([], "r", lazy.spawn("ado repos"), desc=""),
        Key([], "t", lazy.spawn("ado tasks"), desc=""),
        Key([], "c", lazy.spawn("vscode"), desc="code ."),
        Key([], "g", lazy.spawn("google-chrome"), desc="Open Google Chrome"),
    ], name="Launcher", ),
]
